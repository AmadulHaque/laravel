    ...
    return (
        ...
        <div className="flex flex-row w-auto flex-shrink-0 pl-4 pr-2 py-4">
            <div className="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-cyan-500 rounded-3xl">
                <Link to="/" className="flex items-center justify-center h-12 w-12 bg-cyan-50 text-cyan-700 rounded-full" >
                ...
                <li>
                    <Link to="/pos" className="flex items-center">
                        <span className="flex text-white items-center justify-center h-12 w-12 rounded-2xl">
                        <MdAddShoppingCart/>
                        </span>
                    </Link>
                </li>
